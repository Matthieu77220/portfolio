 ...
 */var u_;function pS(){if(u_)return bo;u_=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,u){var d=null;if(u!==void 0&&(d=""+u),l.key!==void 0&&(d=""+l.key),"key"in l){u={};for(var h in l)h!=="key"&&(u[h]=l[h])}else u=l;return l=u.ref,{$$typeof:s,type:r,key:d,ref:l!==void 0?l:null,props:u}}return bo.Fragment=e,bo.jsx=i,bo.jsxs=i,bo}var c_;function mS(){return c_||(c_=1,qf.exports=pS()),qf.exports}var Re=mS(),Yf={exports:{}},st={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
}`;function G1(s,e,i){let r=new r0;const l=new Gt,u=new Gt,d=new en,h=new hE({depthPacking:TM}),m=new pE,p={},g=i.maxTextureSize,v={[Wa]:Fn,[Fn]:Wa,[ea]:ea},x=new la({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Gt},radius:{value:4}},vertexShader:F1,fragmentShader:H1}),M=x.clone();M.defines.HORIZONTAL_PASS=1;const T=new Rr;T.setAttribute("position",new Ai(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const R=new bi(T,x),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=zv;let _=this.type;this.render=function(k,z,q){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||k.length===0)return;const w=s.getRenderTarget(),C=s.getActiveCubeFace(),G=s.getActiveMipmapLevel(),le=s.state;le.setBlending(ka),le.buffers.color.setClear(1,1,1,1),le.buffers.depth.setTest(!0),le.setScissorTest(!1);const se=_!==$i&&this.type===$i,ve=_===$i&&this.type!==$i;for(let he=0,B=k.length;he<B;he++){const Z=k[he],Y=Z.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;l.copy(Y.mapSize);const Ee=Y.getFrameExtents();if(l.multiply(Ee),u.copy(Y.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(u.x=Math.floor(g/Ee.x),l.x=u.x*Ee.x,Y.mapSize.x=u.x),l.y>g&&(u.y=Math.floor(g/Ee.y),l.y=u.y*Ee.y,Y.mapSize.y=u.y)),Y.map===null||se===!0||ve===!0){const $=this.type!==$i?{minFilter:gi,magFilter:gi}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Ar(l.x,l.y,$),Y.map.texture.name=Z.name+".shadowMap",Y.camera.updateProjectionMatrix()}s.setRenderTarget(Y.map),s.clear();const U=Y.getViewportCount();for(let $=0;$<U;$++){const xe=Y.getViewport($);d.set(u.x*xe.x,u.y*xe.y,u.x*xe.z,u.y*xe.w),le.viewport(d),Y.updateMatrices(Z,$),r=Y.getFrustum(),D(z,q,Y.camera,Z,this.type)}Y.isPointLightShadow!==!0&&this.type===$i&&N(Y,q),Y.needsUpdate=!1}_=this.type,S.needsUpdate=!1,s.setRenderTarget(w,C,G)};function N(k,z){const q=e.update(R);x.defines.VSM_SAMPLES!==k.blurSamples&&(x.defines.VSM_SAMPLES=k.blurSamples,M.defines.VSM_SAMPLES=k.blurSamples,x.needsUpdate=!0,M.needsUpdate=!0),k.mapPass===null&&(k.mapPass=new Ar(l.x,l.y)),x.uniforms.shadow_pass.value=k.map.texture,x.uniforms.resolution.value=k.mapSize,x.uniforms.radius.value=k.radius,s.setRenderTarget(k.mapPass),s.clear(),s.renderBufferDirect(z,null,q,x,R,null),M.uniforms.shadow_pass.value=k.mapPass.texture,M.uniforms.resolution.value=k.mapSize,M.uniforms.radius.value=k.radius,s.setRenderTarget(k.map),s.clear(),s.renderBufferDirect(z,null,q,M,R,null)}function L(k,z,q,w){let C=null;const G=q.isPointLight===!0?k.customDistanceMaterial:k.customDepthMaterial;if(G!==void 0)C=G;else if(C=q.isPointLight===!0?m:h,s.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const le=C.uuid,se=z.uuid;let ve=p[le];ve===void 0&&(ve={},p[le]=ve);let he=ve[se];he===void 0&&(he=C.clone(),ve[se]=he,z.addEventListener("dispose",F)),C=he}if(C.visible=z.visible,C.wireframe=z.wireframe,w===$i?C.side=z.shadowSide!==null?z.shadowSide:z.side:C.side=z.shadowSide!==null?z.shadowSide:v[z.side],C.alphaMap=z.alphaMap,C.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,C.map=z.map,C.clipShadows=z.clipShadows,C.clippingPlanes=z.clippingPlanes,C.clipIntersection=z.clipIntersection,C.displacementMap=z.displacementMap,C.displacementScale=z.displacementScale,C.displacementBias=z.displacementBias,C.wireframeLinewidth=z.wireframeLinewidth,C.linewidth=z.linewidth,q.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const le=s.properties.get(C);le.light=q}return C}function D(k,z,q,w,C){if(k.visible===!1)return;if(k.layers.test(z.layers)&&(k.isMesh||k.isLine||k.isPoints)&&(k.castShadow||k.receiveShadow&&C===$i)&&(!k.frustumCulled||r.intersectsObject(k))){k.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,k.matrixWorld);const se=e.update(k),ve=k.material;if(Array.isArray(ve)){const he=se.groups;for(let B=0,Z=he.length;B<Z;B++){const Y=he[B],Ee=ve[Y.materialIndex];if(Ee&&Ee.visible){const U=L(k,Ee,w,C);k.onBeforeShadow(s,k,z,q,se,U,Y),s.renderBufferDirect(q,null,se,U,k,Y),k.onAfterShadow(s,k,z,q,se,U,Y)}}}else if(ve.visible){const he=L(k,ve,w,C);k.onBeforeShadow(s,k,z,q,se,he,null),s.renderBufferDirect(q,null,se,he,k,null),k.onAfterShadow(s,k,z,q,se,he,null)}}const le=k.children;for(let se=0,ve=le.length;se<ve;se++)D(le[se],z,q,w,C)}function F(k){k.target.removeEventListener("dispose",F);for(const q in p){const w=p[q],C=k.target.uuid;C in w&&(w[C].dispose(),delete w[C])}}}const V1={[Bd]:zd,[Id]:Gd,[Fd]:Vd,[Es]:Hd,[zd]:Bd,[Gd]:Id,[Vd]:Fd,[Hd]:Es};function k1(s,e){function i(){let V=!1;const Ne=new en;let Te=null;const Ie=new en(0,0,0,0);return{setMask:function(Ae){Te!==Ae&&!V&&(s.colorMask(Ae,Ae,Ae,Ae),Te=Ae)},setLocked:function(Ae){V=Ae},setClear:function(Ae,_e,He,it,Dt){Dt===!0&&(Ae*=it,_e*=it,He*=it),Ne.set(Ae,_e,He,it),Ie.equals(Ne)===!1&&(s.clearColor(Ae,_e,He,it),Ie.copy(Ne))},reset:function(){V=!1,Te=null,Ie.set(-1,0,0,0)}}}function r(){let V=!1,Ne=!1,Te=null,Ie=null,Ae=null;return{setReversed:function(_e){if(Ne!==_e){const He=e.get("EXT_clip_control");_e?He.clipControlEXT(He.LOWER_LEFT_EXT,He.ZERO_TO_ONE_EXT):He.clipControlEXT(He.LOWER_LEFT_EXT,He.NEGATIVE_ONE_TO_ONE_EXT),Ne=_e;const it=Ae;Ae=null,this.setClear(it)}},getReversed:function(){return Ne},setTest:function(_e){_e?Ce(s.DEPTH_TEST):De(s.DEPTH_TEST)},setMask:function(_e){Te!==_e&&!V&&(s.depthMask(_e),Te=_e)},setFunc:function(_e){if(Ne&&(_e=V1[_e]),Ie!==_e){switch(_e){case Bd:s.depthFunc(s.NEVER);break;case zd:s.depthFunc(s.ALWAYS);break;case Id:s.depthFunc(s.LESS);break;case Es:s.depthFunc(s.LEQUAL);break;case Fd:s.depthFunc(s.EQUAL);break;case Hd:s.depthFunc(s.GEQUAL);break;case Gd:s.depthFunc(s.GREATER);break;case Vd:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Ie=_e}},setLocked:function(_e){V=_e},setClear:function(_e){Ae!==_e&&(Ne&&(_e=1-_e),s.clearDepth(_e),Ae=_e)},reset:function(){V=!1,Te=null,Ie=null,Ae=null,Ne=!1}}}function l(){let V=!1,Ne=null,Te=null,Ie=null,Ae=null,_e=null,He=null,it=null,Dt=null;return{setTest:function(Tt){V||(Tt?Ce(s.STENCIL_TEST):De(s.STENCIL_TEST))},setMask:function(Tt){Ne!==Tt&&!V&&(s.stencilMask(Tt),Ne=Tt)},setFunc:function(Tt,Gn,hn){(Te!==Tt||Ie!==Gn||Ae!==hn)&&(s.stencilFunc(Tt,Gn,hn),Te=Tt,Ie=Gn,Ae=hn)},setOp:function(Tt,Gn,hn){(_e!==Tt||He!==Gn||it!==hn)&&(s.stencilOp(Tt,Gn,hn),_e=Tt,He=Gn,it=hn)},setLocked:function(Tt){V=Tt},setClear:function(Tt){Dt!==Tt&&(s.clearStencil(Tt),Dt=Tt)},reset:function(){V=!1,Ne=null,Te=null,Ie=null,Ae=null,_e=null,He=null,it=null,Dt=null}}}const u=new i,d=new r,h=new l,m=new WeakMap,p=new WeakMap;let g={},v={},x=new WeakMap,M=[],T=null,R=!1,S=null,_=null,N=null,L=null,D=null,F=null,k=null,z=new wt(0,0,0),q=0,w=!1,C=null,G=null,le=null,se=null,ve=null;const he=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,Z=0;const Y=s.getParameter(s.VERSION);Y.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(Y)[1]),B=Z>=1):Y.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),B=Z>=2);let Ee=null,U={};const $=s.getParameter(s.SCISSOR_BOX),xe=s.getParameter(s.VIEWPORT),ye=new en().fromArray($),Q=new en().fromArray(xe);function me(V,Ne,Te,Ie){const Ae=new Uint8Array(4),_e=s.createTexture();s.bindTexture(V,_e),s.texParameteri(V,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(V,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let He=0;He<Te;He++)V===s.TEXTURE_3D||V===s.TEXTURE_2D_ARRAY?s.texImage3D(Ne,0,s.RGBA,1,1,Ie,0,s.RGBA,s.UNSIGNED_BYTE,Ae):s.texImage2D(Ne+He,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Ae);return _e}const Me={};Me[s.TEXTURE_2D]=me(s.TEXTURE_2D,s.TEXTURE_2D,1),Me[s.TEXTURE_CUBE_MAP]=me(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),Me[s.TEXTURE_2D_ARRAY]=me(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),Me[s.TEXTURE_3D]=me(s.TEXTURE_3D,s.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),h.setClear(0),Ce(s.DEPTH_TEST),d.setFunc(Es),Mt(!1),ht(T_),Ce(s.CULL_FACE),I(ka);function Ce(V){g[V]!==!0&&(s.enable(V),g[V]=!0)}function De(V){g[V]!==!1&&(s.disable(V),g[V]=!1)}function lt(V,Ne){return v[V]!==Ne?(s.bindFramebuffer(V,Ne),v[V]=Ne,V===s.DRAW_FRAMEBUFFER&&(v[s.FRAMEBUFFER]=Ne),V===s.FRAMEBUFFER&&(v[s.DRAW_FRAMEBUFFER]=Ne),!0):!1}function Je(V,Ne){let Te=M,Ie=!1;if(V){Te=x.get(Ne),Te===void 0&&(Te=[],x.set(Ne,Te));const Ae=V.textures;if(Te.length!==Ae.length||Te[0]!==s.COLOR_ATTACHMENT0){for(let _e=0,He=Ae.length;_e<He;_e++)Te[_e]=s.COLOR_ATTACHMENT0+_e;Te.length=Ae.length,Ie=!0}}else Te[0]!==s.BACK&&(Te[0]=s.BACK,Ie=!0);Ie&&s.drawBuffers(Te)}function Nt(V){return T!==V?(s.useProgram(V),T=V,!0):!1}const It={[Sr]:s.FUNC_ADD,[Ky]:s.FUNC_SUBTRACT,[Qy]:s.FUNC_REVERSE_SUBTRACT};It[Jy]=s.MIN,It[$y]=s.MAX;const gt={[eM]:s.ZERO,[tM]:s.ONE,[nM]:s.SRC_COLOR,[Od]:s.SRC_ALPHA,[lM]:s.SRC_ALPHA_SATURATE,[sM]:s.DST_COLOR,[aM]:s.DST_ALPHA,[iM]:s.ONE_MINUS_SRC_COLOR,[Pd]:s.ONE_MINUS_SRC_ALPHA,[oM]:s.ONE_MINUS_DST_COLOR,[rM]:s.ONE_MINUS_DST_ALPHA,[uM]:s.CONSTANT_COLOR,[cM]:s.ONE_MINUS_CONSTANT_COLOR,[fM]:s.CONSTANT_ALPHA,[dM]:s.ONE_MINUS_CONSTANT_ALPHA};function I(V,Ne,Te,Ie,Ae,_e,He,it,Dt,Tt){if(V===ka){R===!0&&(De(s.BLEND),R=!1);return}if(R===!1&&(Ce(s.BLEND),R=!0),V!==Zy){if(V!==S||Tt!==w){if((_!==Sr||D!==Sr)&&(s.blendEquation(s.FUNC_ADD),_=Sr,D=Sr),Tt)switch(V){case Ss:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case b_:s.blendFunc(s.ONE,s.ONE);break;case A_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case R_:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}else switch(V){case Ss:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case b_:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case A_:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case R_:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",V);break}N=null,L=null,F=null,k=null,z.set(0,0,0),q=0,S=V,w=Tt}return}Ae=Ae||Ne,_e=_e||Te,He=He||Ie,(Ne!==_||Ae!==D)&&(s.blendEquationSeparate(It[Ne],It[Ae]),_=Ne,D=Ae),(Te!==N||Ie!==L||_e!==F||He!==k)&&(s.blendFuncSeparate(gt[Te],gt[Ie],gt[_e],gt[He]),N=Te,L=Ie,F=_e,k=He),(it.equals(z)===!1||Dt!==q)&&(s.blendColor(it.r,it.g,it.b,Dt),z.copy(it),q=Dt),S=V,w=!1}function xn(V,Ne){V.side===ea?De(s.CULL_FACE):Ce(s.CULL_FACE);let Te=V.side===Fn;Ne&&(Te=!Te),Mt(Te),V.blending===Ss&&V.transparent===!1?I(ka):I(V.blending,V.blendEquation,V.blendSrc,V.blendDst,V.blendEquationAlpha,V.blendSrcAlpha,V.blendDstAlpha,V.blendColor,V.blendAlpha,V.premultipliedAlpha),d.setFunc(V.depthFunc),d.setTest(V.depthTest),d.setMask(V.depthWrite),u.setMask(V.colorWrite);const Ie=V.stencilWrite;h.setTest(Ie),Ie&&(h.setMask(V.stencilWriteMask),h.setFunc(V.stencilFunc,V.stencilRef,V.stencilFuncMask),h.setOp(V.stencilFail,V.stencilZFail,V.stencilZPass)),_t(V.polygonOffset,V.polygonOffsetFactor,V.polygonOffsetUnits),V.alphaToCoverage===!0?Ce(s.SAMPLE_ALPHA_TO_COVERAGE):De(s.SAMPLE_ALPHA_TO_COVERAGE)}function Mt(V){C!==V&&(V?s.frontFace(s.CW):s.frontFace(s.CCW),C=V)}function ht(V){V!==qy?(Ce(s.CULL_FACE),V!==G&&(V===T_?s.cullFace(s.BACK):V===Yy?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):De(s.CULL_FACE),G=V}function ke(V){V!==le&&(B&&s.lineWidth(V),le=V)}function _t(V,Ne,Te){V?(Ce(s.POLYGON_OFFSET_FILL),(se!==Ne||ve!==Te)&&(s.polygonOffset(Ne,Te),se=Ne,ve=Te)):De(s.POLYGON_OFFSET_FILL)}function Ze(V){V?Ce(s.SCISSOR_TEST):De(s.SCISSOR_TEST)}function rt(V){V===void 0&&(V=s.TEXTURE0+he-1),Ee!==V&&(s.activeTexture(V),Ee=V)}function Qt(V,Ne,Te){Te===void 0&&(Ee===null?Te=s.TEXTURE0+he-1:Te=Ee);let Ie=U[Te];Ie===void 0&&(Ie={type:void 0,texture:void 0},U[Te]=Ie),(Ie.type!==V||Ie.texture!==Ne)&&(Ee!==Te&&(s.activeTexture(Te),Ee=Te),s.bindTexture(V,Ne||Me[V]),Ie.type=V,Ie.texture=Ne)}function O(){const V=U[Ee];V!==void 0&&V.type!==void 0&&(s.bindTexture(V.type,null),V.type=void 0,V.texture=void 0)}function E(){try{s.compressedTexImage2D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ee(){try{s.compressedTexImage3D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ce(){try{s.texSubImage2D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function pe(){try{s.texSubImage3D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function oe(){try{s.compressedTexSubImage2D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Be(){try{s.compressedTexSubImage3D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Le(){try{s.texStorage2D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Ve(){try{s.texStorage3D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Xe(){try{s.texImage2D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function Se(){try{s.texImage3D(...arguments)}catch(V){console.error("THREE.WebGLState:",V)}}function ze(V){ye.equals(V)===!1&&(s.scissor(V.x,V.y,V.z,V.w),ye.copy(V))}function Ye(V){Q.equals(V)===!1&&(s.viewport(V.x,V.y,V.z,V.w),Q.copy(V))}function je(V,Ne){let Te=p.get(Ne);Te===void 0&&(Te=new WeakMap,p.set(Ne,Te));let Ie=Te.get(V);Ie===void 0&&(Ie=s.getUniformBlockIndex(Ne,V.name),Te.set(V,Ie))}function we(V,Ne){const Ie=p.get(Ne).get(V);m.get(Ne)!==Ie&&(s.uniformBlockBinding(Ne,Ie,V.__bindingPointIndex),m.set(Ne,Ie))}function at(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),d.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},Ee=null,U={},v={},x=new WeakMap,M=[],T=null,R=!1,S=null,_=null,N=null,L=null,D=null,F=null,k=null,z=new wt(0,0,0),q=0,w=!1,C=null,G=null,le=null,se=null,ve=null,ye.set(0,0,s.canvas.width,s.canvas.height),Q.set(0,0,s.canvas.width,s.canvas.height),u.reset(),d.reset(),h.reset()}return{buffers:{color:u,depth:d,stencil:h},enable:Ce,disable:De,bindFramebuffer:lt,drawBuffers:Je,useProgram:Nt,setBlending:I,setMaterial:xn,setFlipSided:Mt,setCullFace:ht,setLineWidth:ke,setPolygonOffset:_t,setScissorTest:Ze,activeTexture:rt,bindTexture:Qt,unbindTexture:O,compressedTexImage2D:E,compressedTexImage3D:ee,texImage2D:Xe,texImage3D:Se,updateUBOMapping:je,uniformBlockBinding:we,texStorage2D:Le,texStorage3D:Ve,texSubImage2D:ce,texSubImage3D:pe,compressedTexSubImage2D:oe,compressedTexSubImage3D:Be,scissor:ze,viewport:Ye,reset:at}}function X1(s,e,i,r,l,u,d){const h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Gt,g=new WeakMap;let v;const x=new WeakMap;let M=!1;try{M=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(O,E){return M?new OffscreenCanvas(O,E):Iu("canvas")}function R(O,E,ee){let ce=1;const pe=Qt(O);if((pe.width>ee||pe.height>ee)&&(ce=ee/Math.max(pe.width,pe.height)),ce<1)if(typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&O instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&O instanceof ImageBitmap||typeof VideoFrame<"u"&&O instanceof VideoFrame){const oe=Math.floor(ce*pe.width),Be=Math.floor(ce*pe.height);v===void 0&&(v=T(oe,Be));const Le=E?T(oe,Be):v;return Le.width=oe,Le.height=Be,Le.getContext("2d").drawImage(O,0,0,oe,Be),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+pe.width+"x"+pe.height+") to ("+oe+"x"+Be+")."),Le}else return"data"in O&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+pe.width+"x"+pe.height+")."),O;return O}function S(O){return O.generateMipmaps}function _(O){s.generateMipmap(O)}function N(O){return O.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:O.isWebGL3DRenderTarget?s.TEXTURE_3D:O.isWebGLArrayRenderTarget||O.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function L(O,E,ee,ce,pe=!1){if(O!==null){if(s[O]!==void 0)return s[O];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+O+"'")}let oe=E;if(E===s.RED&&(ee===s.FLOAT&&(oe=s.R32F),ee===s.HALF_FLOAT&&(oe=s.R16F),ee===s.UNSIGNED_BYTE&&(oe=s.R8)),E===s.RED_INTEGER&&(ee===s.UNSIGNED_BYTE&&(oe=s.R8UI),ee===s.UNSIGNED_SHORT&&(oe=s.R16UI),ee===s.UNSIGNED_INT&&(oe=s.R32UI),ee===s.BYTE&&(oe=s.R8I),ee===s.SHORT&&(oe=s.R16I),ee===s.INT&&(oe=s.R32I)),E===s.RG&&(ee===s.FLOAT&&(oe=s.RG32F),ee===s.HALF_FLOAT&&(oe=s.RG16F),ee===s.UNSIGNED_BYTE&&(oe=s.RG8)),E===s.RG_INTEGER&&(ee===s.UNSIGNED_BYTE&&(oe=s.RG8UI),ee===s.UNSIGNED_SHORT&&(oe=s.RG16UI),ee===s.UNSIGNED_INT&&(oe=s.RG32UI),ee===s.BYTE&&(oe=s.RG8I),ee===s.SHORT&&(oe=s.RG16I),ee===s.INT&&(oe=s.RG32I)),E===s.RGB_INTEGER&&(ee===s.UNSIGNED_BYTE&&(oe=s.RGB8UI),ee===s.UNSIGNED_SHORT&&(oe=s.RGB16UI),ee===s.UNSIGNED_INT&&(oe=s.RGB32UI),ee===s.BYTE&&(oe=s.RGB8I),ee===s.SHORT&&(oe=s.RGB16I),ee===s.INT&&(oe=s.RGB32I)),E===s.RGBA_INTEGER&&(ee===s.UNSIGNED_BYTE&&(oe=s.RGBA8UI),ee===s.UNSIGNED_SHORT&&(oe=s.RGBA16UI),ee===s.UNSIGNED_INT&&(oe=s.RGBA32UI),ee===s.BYTE&&(oe=s.RGBA8I),ee===s.SHORT&&(oe=s.RGBA16I),ee===s.INT&&(oe=s.RGBA32I)),E===s.RGB&&ee===s.UNSIGNED_INT_5_9_9_9_REV&&(oe=s.RGB9_E5),E===s.RGBA){const Be=pe?Bu:At.getTransfer(ce);ee===s.FLOAT&&(oe=s.RGBA32F),ee===s.HALF_FLOAT&&(oe=s.RGBA16F),ee===s.UNSIGNED_BYTE&&(oe=Be===zt?s.SRGB8_ALPHA8:s.RGBA8),ee===s.UNSIGNED_SHORT_4_4_4_4&&(oe=s.RGBA4),ee===s.UNSIGNED_SHORT_5_5_5_1&&(oe=s.RGB5_A1)}return(oe===s.R16F||oe===s.R32F||oe===s.RG16F||oe===s.RG32F||oe===s.RGBA16F||oe===s.RGBA32F)&&e.get("EXT_color_buffer_float"),oe}function D(O,E){let ee;return O?E===null||E===br||E===Bo?ee=s.DEPTH24_STENCIL8:E===ta?ee=s.DEPTH32F_STENCIL8:E===Po&&(ee=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===br||E===Bo?ee=s.DEPTH_COMPONENT24:E===ta?ee=s.DEPTH_COMPONENT32F:E===Po&&(ee=s.DEPTH_COMPONENT16),ee}function F(O,E){return S(O)===!0||O.isFramebufferTexture&&O.minFilter!==gi&&O.minFilter!==Ti?Math.log2(Math.max(E.width,E.height))+1:O.mipmaps!==void 0&&O.mipmaps.length>0?O.mipmaps.length:O.isCompressedTexture&&Array.isArray(O.image)?E.mipmaps.length:1}function k(O){const E=O.target;E.removeEventListener("dispose",k),q(E),E.isVideoTexture&&g.delete(E)}function z(O){const E=O.target;E.removeEventListener("dispose",z),C(E)}function q(O){const E=r.get(O);if(E.__webglInit===void 0)return;const ee=O.source,ce=x.get(ee);if(ce){const pe=ce[E.__cacheKey];pe.usedTimes--,pe.usedTimes===0&&w(O),Object.keys(ce).length===0&&x.delete(ee)}r.remove(O)}function w(O){const E=r.get(O);s.deleteTexture(E.__webglTexture);const ee=O.source,ce=x.get(ee);delete ce[E.__cacheKey],d.memory.textures--}function C(O){const E=r.get(O);if(O.depthTexture&&(O.depthTexture.dispose(),r.remove(O.depthTexture)),O.isWebGLCubeRenderTarget)for(let ce=0;ce<6;ce++){if(Array.isArray(E.__webglFramebuffer[ce]))for(let pe=0;pe<E.__webglFramebuffer[ce].length;pe++)s.deleteFramebuffer(E.__webglFramebuffer[ce][pe]);else s.deleteFramebuffer(E.__webglFramebuffer[ce]);E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer[ce])}else{if(Array.isArray(E.__webglFramebuffer))for(let ce=0;ce<E.__webglFramebuffer.length;ce++)s.deleteFramebuffer(E.__webglFramebuffer[ce]);else s.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&s.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&s.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ce=0;ce<E.__webglColorRenderbuffer.length;ce++)E.__webglColorRenderbuffer[ce]&&s.deleteRenderbuffer(E.__webglColorRenderbuffer[ce]);E.__webglDepthRenderbuffer&&s.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const ee=O.textures;for(let ce=0,pe=ee.length;ce<pe;ce++){const oe=r.get(ee[ce]);oe.__webglTexture&&(s.deleteTexture(oe.__webglTexture),d.memory.textures--),r.remove(ee[ce])}r.remove(O)}let G=0;function le(){G=0}function se(){const O=G;return O>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+O+" texture units while this GPU supports only "+l.maxTextures),G+=1,O}function ve(O){const E=[];return E.push(O.wrapS),E.push(O.wrapT),E.push(O.wrapR||0),E.push(O.magFilter),E.push(O.minFilter),E.push(O.anisotropy),E.push(O.internalFormat),E.push(O.format),E.push(O.type),E.push(O.generateMipmaps),E.push(O.premultiplyAlpha),E.push(O.flipY),E.push(O.unpackAlignment),E.push(O.colorSpace),E.join()}function he(O,E){const ee=r.get(O);if(O.isVideoTexture&&Ze(O),O.isRenderTargetTexture===!1&&O.version>0&&ee.__version!==O.version){const ce=O.image;if(ce===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ce.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Me(ee,O,E);return}}i.bindTexture(s.TEXTURE_2D,ee.__webglTexture,s.TEXTURE0+E)}function B(O,E){const ee=r.get(O);if(O.version>0&&ee.__version!==O.version){Me(ee,O,E);return}i.bindTexture(s.TEXTURE_2D_ARRAY,ee.__webglTexture,s.TEXTURE0+E)}function Z(O,E){const ee=r.get(O);if(O.version>0&&ee.__version!==O.version){Me(ee,O,E);return}i.bindTexture(s.TEXTURE_3D,ee.__webglTexture,s.TEXTURE0+E)}function Y(O,E){const ee=r.get(O);if(O.version>0&&ee.__version!==O.version){Ce(ee,O,E);return}i.bindTexture(s.TEXTURE_CUBE_MAP,ee.__webglTexture,s.TEXTURE0+E)}const Ee={[Wd]:s.REPEAT,[Mr]:s.CLAMP_TO_EDGE,[qd]:s.MIRRORED_REPEAT},U={[gi]:s.NEAREST,[MM]:s.NEAREST_MIPMAP_NEAREST,[ru]:s.NEAREST_MIPMAP_LINEAR,[Ti]:s.LINEAR,[ed]:s.LINEAR_MIPMAP_NEAREST,[Er]:s.LINEAR_MIPMAP_LINEAR},$={[RM]:s.NEVER,[NM]:s.ALWAYS,[CM]:s.LESS,[jv]:s.LEQUAL,[wM]:s.EQUAL,[LM]:s.GEQUAL,[DM]:s.GREATER,[UM]:s.NOTEQUAL};function xe(O,E){if(E.type===ta&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===Ti||E.magFilter===ed||E.magFilter===ru||E.magFilter===Er||E.minFilter===Ti||E.minFilter===ed||E.minFilter===ru||E.minFilter===Er)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(O,s.TEXTURE_WRAP_S,Ee[E.wrapS]),s.texParameteri(O,s.TEXTURE_WRAP_T,Ee[E.wrapT]),(O===s.TEXTURE_3D||O===s.TEXTURE_2D_ARRAY)&&s.texParameteri(O,s.TEXTURE_WRAP_R,Ee[E.wrapR]),s.texParameteri(O,s.TEXTURE_MAG_FILTER,U[E.magFilter]),s.texParameteri(O,s.TEXTURE_MIN_FILTER,U[E.minFilter]),E.compareFunction&&(s.texParameteri(O,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(O,s.TEXTURE_COMPARE_FUNC,$[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===gi||E.minFilter!==ru&&E.minFilter!==Er||E.type===ta&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const ee=e.get("EXT_texture_filter_anisotropic");s.texParameterf(O,ee.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function ye(O,E){let ee=!1;O.__webglInit===void 0&&(O.__webglInit=!0,E.addEventListener("dispose",k));const ce=E.source;let pe=x.get(ce);pe===void 0&&(pe={},x.set(ce,pe));const oe=ve(E);if(oe!==O.__cacheKey){pe[oe]===void 0&&(pe[oe]={texture:s.createTexture(),usedTimes:0},d.memory.textures++,ee=!0),pe[oe].usedTimes++;const Be=pe[O.__cacheKey];Be!==void 0&&(pe[O.__cacheKey].usedTimes--,Be.usedTimes===0&&w(E)),O.__cacheKey=oe,O.__webglTexture=pe[oe].texture}return ee}function Q(O,E,ee){return Math.floor(Math.floor(O/ee)/E)}function me(O,E,ee,ce){const oe=O.updateRanges;if(oe.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,E.width,E.height,ee,ce,E.data);else{oe.sort((Se,ze)=>Se.start-ze.start);let Be=0;for(let Se=1;Se<oe.length;Se++){const ze=oe[Be],Ye=oe[Se],je=ze.start+ze.count,we=Q(Ye.start,E.width,4),at=Q(ze.start,E.width,4);Ye.start<=je+1&&we===at&&Q(Ye.start+Ye.count-1,E.width,4)===we?ze.count=Math.max(ze.count,Ye.start+Ye.count-ze.start):(++Be,oe[Be]=Ye)}oe.length=Be+1;const Le=s.getParameter(s.UNPACK_ROW_LENGTH),Ve=s.getParameter(s.UNPACK_SKIP_PIXELS),Xe=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,E.width);for(let Se=0,ze=oe.length;Se<ze;Se++){const Ye=oe[Se],je=Math.floor(Ye.start/4),we=Math.ceil(Ye.count/4),at=je%E.width,V=Math.floor(je/E.width),Ne=we,Te=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,at),s.pixelStorei(s.UNPACK_SKIP_ROWS,V),i.texSubImage2D(s.TEXTURE_2D,0,at,V,Ne,Te,ee,ce,E.data)}O.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,Le),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Ve),s.pixelStorei(s.UNPACK_SKIP_ROWS,Xe)}}function Me(O,E,ee){let ce=s.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ce=s.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ce=s.TEXTURE_3D);const pe=ye(O,E),oe=E.source;i.bindTexture(ce,O.__webglTexture,s.TEXTURE0+ee);const Be=r.get(oe);if(oe.version!==Be.__version||pe===!0){i.activeTexture(s.TEXTURE0+ee);const Le=At.getPrimaries(At.workingColorSpace),Ve=E.colorSpace===Va?null:At.getPrimaries(E.colorSpace),Xe=E.colorSpace===Va||Le===Ve?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xe);let Se=R(E.image,!1,l.maxTextureSize);Se=rt(E,Se);const ze=u.convert(E.format,E.colorSpace),Ye=u.convert(E.type);let je=L(E.internalFormat,ze,Ye,E.colorSpace,E.isVideoTexture);xe(ce,E);let we;const at=E.mipmaps,V=E.isVideoTexture!==!0,Ne=Be.__version===void 0||pe===!0,Te=oe.dataReady,Ie=F(E,Se);if(E.isDepthTexture)je=D(E.format===Io,E.type),Ne&&(V?i.texStorage2D(s.TEXTURE_2D,1,je,Se.width,Se.height):i.texImage2D(s.TEXTURE_2D,0,je,Se.width,Se.height,0,ze,Ye,null));else if(E.isDataTexture)if(at.length>0){V&&Ne&&i.texStorage2D(s.TEXTURE_2D,Ie,je,at[0].width,at[0].height);for(let Ae=0,_e=at.length;Ae<_e;Ae++)we=at[Ae],V?Te&&i.texSubImage2D(s.TEXTURE_2D,Ae,0,0,we.width,we.height,ze,Ye,we.data):i.texImage2D(s.TEXTURE_2D,Ae,je,we.width,we.height,0,ze,Ye,we.data);E.generateMipmaps=!1}else V?(Ne&&i.texStorage2D(s.TEXTURE_2D,Ie,je,Se.width,Se.height),Te&&me(E,Se,ze,Ye)):i.texImage2D(s.TEXTURE_2D,0,je,Se.width,Se.height,0,ze,Ye,Se.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){V&&Ne&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Ie,je,at[0].width,at[0].height,Se.depth);for(let Ae=0,_e=at.length;Ae<_e;Ae++)if(we=at[Ae],E.format!==mi)if(ze!==null)if(V){if(Te)if(E.layerUpdates.size>0){const He=j_(we.width,we.height,E.format,E.type);for(const it of E.layerUpdates){const Dt=we.data.subarray(it*He/we.data.BYTES_PER_ELEMENT,(it+1)*He/we.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Ae,0,0,it,we.width,we.height,1,ze,Dt)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Ae,0,0,0,we.width,we.height,Se.depth,ze,we.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Ae,je,we.width,we.height,Se.depth,0,we.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else V?Te&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,Ae,0,0,0,we.width,we.height,Se.depth,ze,Ye,we.data):i.texImage3D(s.TEXTURE_2D_ARRAY,Ae,je,we.width,we.height,Se.depth,0,ze,Ye,we.data)}else{V&&Ne&&i.texStorage2D(s.TEXTURE_2D,Ie,je,at[0].width,at[0].height);for(let Ae=0,_e=at.length;Ae<_e;Ae++)we=at[Ae],E.format!==mi?ze!==null?V?Te&&i.compressedTexSubImage2D(s.TEXTURE_2D,Ae,0,0,we.width,we.height,ze,we.data):i.compressedTexImage2D(s.TEXTURE_2D,Ae,je,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):V?Te&&i.texSubImage2D(s.TEXTURE_2D,Ae,0,0,we.width,we.height,ze,Ye,we.data):i.texImage2D(s.TEXTURE_2D,Ae,je,we.width,we.height,0,ze,Ye,we.data)}else if(E.isDataArrayTexture)if(V){if(Ne&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Ie,je,Se.width,Se.height,Se.depth),Te)if(E.layerUpdates.size>0){const Ae=j_(Se.width,Se.height,E.format,E.type);for(const _e of E.layerUpdates){const He=Se.data.subarray(_e*Ae/Se.data.BYTES_PER_ELEMENT,(_e+1)*Ae/Se.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,_e,Se.width,Se.height,1,ze,Ye,He)}E.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Se.width,Se.height,Se.depth,ze,Ye,Se.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,je,Se.width,Se.height,Se.depth,0,ze,Ye,Se.data);else if(E.isData3DTexture)V?(Ne&&i.texStorage3D(s.TEXTURE_3D,Ie,je,Se.width,Se.height,Se.depth),Te&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Se.width,Se.height,Se.depth,ze,Ye,Se.data)):i.texImage3D(s.TEXTURE_3D,0,je,Se.width,Se.height,Se.depth,0,ze,Ye,Se.data);else if(E.isFramebufferTexture){if(Ne)if(V)i.texStorage2D(s.TEXTURE_2D,Ie,je,Se.width,Se.height);else{let Ae=Se.width,_e=Se.height;for(let He=0;He<Ie;He++)i.texImage2D(s.TEXTURE_2D,He,je,Ae,_e,0,ze,Ye,null),Ae>>=1,_e>>=1}}else if(at.length>0){if(V&&Ne){const Ae=Qt(at[0]);i.texStorage2D(s.TEXTURE_2D,Ie,je,Ae.width,Ae.height)}for(let Ae=0,_e=at.length;Ae<_e;Ae++)we=at[Ae],V?Te&&i.texSubImage2D(s.TEXTURE_2D,Ae,0,0,ze,Ye,we):i.texImage2D(s.TEXTURE_2D,Ae,je,ze,Ye,we);E.generateMipmaps=!1}else if(V){if(Ne){const Ae=Qt(Se);i.texStorage2D(s.TEXTURE_2D,Ie,je,Ae.width,Ae.height)}Te&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,ze,Ye,Se)}else i.texImage2D(s.TEXTURE_2D,0,je,ze,Ye,Se);S(E)&&_(ce),Be.__version=oe.version,E.onUpdate&&E.onUpdate(E)}O.__version=E.version}function Ce(O,E,ee){if(E.image.length!==6)return;const ce=ye(O,E),pe=E.source;i.bindTexture(s.TEXTURE_CUBE_MAP,O.__webglTexture,s.TEXTURE0+ee);const oe=r.get(pe);if(pe.version!==oe.__version||ce===!0){i.activeTexture(s.TEXTURE0+ee);const Be=At.getPrimaries(At.workingColorSpace),Le=E.colorSpace===Va?null:At.getPrimaries(E.colorSpace),Ve=E.colorSpace===Va||Be===Le?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,E.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,E.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);const Xe=E.isCompressedTexture||E.image[0].isCompressedTexture,Se=E.image[0]&&E.image[0].isDataTexture,ze=[];for(let _e=0;_e<6;_e++)!Xe&&!Se?ze[_e]=R(E.image[_e],!0,l.maxCubemapSize):ze[_e]=Se?E.image[_e].image:E.image[_e],ze[_e]=rt(E,ze[_e]);const Ye=ze[0],je=u.convert(E.format,E.colorSpace),we=u.convert(E.type),at=L(E.internalFormat,je,we,E.colorSpace),V=E.isVideoTexture!==!0,Ne=oe.__version===void 0||ce===!0,Te=pe.dataReady;let Ie=F(E,Ye);xe(s.TEXTURE_CUBE_MAP,E);let Ae;if(Xe){V&&Ne&&i.texStorage2D(s.TEXTURE_CUBE_MAP,Ie,at,Ye.width,Ye.height);for(let _e=0;_e<6;_e++){Ae=ze[_e].mipmaps;for(let He=0;He<Ae.length;He++){const it=Ae[He];E.format!==mi?je!==null?V?Te&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He,0,0,it.width,it.height,je,it.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He,at,it.width,it.height,0,it.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):V?Te&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He,0,0,it.width,it.height,je,we,it.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He,at,it.width,it.height,0,je,we,it.data)}}}else{if(Ae=E.mipmaps,V&&Ne){Ae.length>0&&Ie++;const _e=Qt(ze[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,Ie,at,_e.width,_e.height)}for(let _e=0;_e<6;_e++)if(Se){V?Te&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,0,0,ze[_e].width,ze[_e].height,je,we,ze[_e].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,at,ze[_e].width,ze[_e].height,0,je,we,ze[_e].data);for(let He=0;He<Ae.length;He++){const Dt=Ae[He].image[_e].image;V?Te&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He+1,0,0,Dt.width,Dt.height,je,we,Dt.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He+1,at,Dt.width,Dt.height,0,je,we,Dt.data)}}else{V?Te&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,0,0,je,we,ze[_e]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,0,at,je,we,ze[_e]);for(let He=0;He<Ae.length;He++){const it=Ae[He];V?Te&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He+1,0,0,je,we,it.image[_e]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+_e,He+1,at,je,we,it.image[_e])}}}S(E)&&_(s.TEXTURE_CUBE_MAP),oe.__version=pe.version,E.onUpdate&&E.onUpdate(E)}O.__version=E.version}function De(O,E,ee,ce,pe,oe){const Be=u.convert(ee.format,ee.colorSpace),Le=u.convert(ee.type),Ve=L(ee.internalFormat,Be,Le,ee.colorSpace),Xe=r.get(E),Se=r.get(ee);if(Se.__renderTarget=E,!Xe.__hasExternalTextures){const ze=Math.max(1,E.width>>oe),Ye=Math.max(1,E.height>>oe);pe===s.TEXTURE_3D||pe===s.TEXTURE_2D_ARRAY?i.texImage3D(pe,oe,Ve,ze,Ye,E.depth,0,Be,Le,null):i.texImage2D(pe,oe,Ve,ze,Ye,0,Be,Le,null)}i.bindFramebuffer(s.FRAMEBUFFER,O),_t(E)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,ce,pe,Se.__webglTexture,0,ke(E)):(pe===s.TEXTURE_2D||pe>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&pe<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,ce,pe,Se.__webglTexture,oe),i.bindFramebuffer(s.FRAMEBUFFER,null)}function lt(O,E,ee){if(s.bindRenderbuffer(s.RENDERBUFFER,O),E.depthBuffer){const ce=E.depthTexture,pe=ce&&ce.isDepthTexture?ce.type:null,oe=D(E.stencilBuffer,pe),Be=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Le=ke(E);_t(E)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Le,oe,E.width,E.height):ee?s.renderbufferStorageMultisample(s.RENDERBUFFER,Le,oe,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,oe,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,Be,s.RENDERBUFFER,O)}else{const ce=E.textures;for(let pe=0;pe<ce.length;pe++){const oe=ce[pe],Be=u.convert(oe.format,oe.colorSpace),Le=u.convert(oe.type),Ve=L(oe.internalFormat,Be,Le,oe.colorSpace),Xe=ke(E);ee&&_t(E)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Xe,Ve,E.width,E.height):_t(E)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Xe,Ve,E.width,E.height):s.renderbufferStorage(s.RENDERBUFFER,Ve,E.width,E.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Je(O,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,O),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ce=r.get(E.depthTexture);ce.__renderTarget=E,(!ce.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),he(E.depthTexture,0);const pe=ce.__webglTexture,oe=ke(E);if(E.depthTexture.format===zo)_t(E)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,pe,0,oe):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,pe,0);else if(E.depthTexture.format===Io)_t(E)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,pe,0,oe):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,pe,0);else throw new Error("Unknown depthTexture format")}function Nt(O){const E=r.get(O),ee=O.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==O.depthTexture){const ce=O.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ce){const pe=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ce.removeEventListener("dispose",pe)};ce.addEventListener("dispose",pe),E.__depthDisposeCallback=pe}E.__boundDepthTexture=ce}if(O.depthTexture&&!E.__autoAllocateDepthBuffer){if(ee)throw new Error("target.depthTexture not supported in Cube render targets");const ce=O.texture.mipmaps;ce&&ce.length>0?Je(E.__webglFramebuffer[0],O):Je(E.__webglFramebuffer,O)}else if(ee){E.__webglDepthbuffer=[];for(let ce=0;ce<6;ce++)if(i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[ce]),E.__webglDepthbuffer[ce]===void 0)E.__webglDepthbuffer[ce]=s.createRenderbuffer(),lt(E.__webglDepthbuffer[ce],O,!1);else{const pe=O.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,oe=E.__webglDepthbuffer[ce];s.bindRenderbuffer(s.RENDERBUFFER,oe),s.framebufferRenderbuffer(s.FRAMEBUFFER,pe,s.RENDERBUFFER,oe)}}else{const ce=O.texture.mipmaps;if(ce&&ce.length>0?i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=s.createRenderbuffer(),lt(E.__webglDepthbuffer,O,!1);else{const pe=O.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,oe=E.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,oe),s.framebufferRenderbuffer(s.FRAMEBUFFER,pe,s.RENDERBUFFER,oe)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function It(O,E,ee){const ce=r.get(O);E!==void 0&&De(ce.__webglFramebuffer,O,O.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),ee!==void 0&&Nt(O)}function gt(O){const E=O.texture,ee=r.get(O),ce=r.get(E);O.addEventListener("dispose",z);const pe=O.textures,oe=O.isWebGLCubeRenderTarget===!0,Be=pe.length>1;if(Be||(ce.__webglTexture===void 0&&(ce.__webglTexture=s.createTexture()),ce.__version=E.version,d.memory.textures++),oe){ee.__webglFramebuffer=[];for(let Le=0;Le<6;Le++)if(E.mipmaps&&E.mipmaps.length>0){ee.__webglFramebuffer[Le]=[];for(let Ve=0;Ve<E.mipmaps.length;Ve++)ee.__webglFramebuffer[Le][Ve]=s.createFramebuffer()}else ee.__webglFramebuffer[Le]=s.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){ee.__webglFramebuffer=[];for(let Le=0;Le<E.mipmaps.length;Le++)ee.__webglFramebuffer[Le]=s.createFramebuffer()}else ee.__webglFramebuffer=s.createFramebuffer();if(Be)for(let Le=0,Ve=pe.length;Le<Ve;Le++){const Xe=r.get(pe[Le]);Xe.__webglTexture===void 0&&(Xe.__webglTexture=s.createTexture(),d.memory.textures++)}if(O.samples>0&&_t(O)===!1){ee.__webglMultisampledFramebuffer=s.createFramebuffer(),ee.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,ee.__webglMultisampledFramebuffer);for(let Le=0;Le<pe.length;Le++){const Ve=pe[Le];ee.__webglColorRenderbuffer[Le]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,ee.__webglColorRenderbuffer[Le]);const Xe=u.convert(Ve.format,Ve.colorSpace),Se=u.convert(Ve.type),ze=L(Ve.internalFormat,Xe,Se,Ve.colorSpace,O.isXRRenderTarget===!0),Ye=ke(O);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ye,ze,O.width,O.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Le,s.RENDERBUFFER,ee.__webglColorRenderbuffer[Le])}s.bindRenderbuffer(s.RENDERBUFFER,null),O.depthBuffer&&(ee.__webglDepthRenderbuffer=s.createRenderbuffer(),lt(ee.__webglDepthRenderbuffer,O,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(oe){i.bindTexture(s.TEXTURE_CUBE_MAP,ce.__webglTexture),xe(s.TEXTURE_CUBE_MAP,E);for(let Le=0;Le<6;Le++)if(E.mipmaps&&E.mipmaps.length>0)for(let Ve=0;Ve<E.mipmaps.length;Ve++)De(ee.__webglFramebuffer[Le][Ve],O,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,Ve);else De(ee.__webglFramebuffer[Le],O,E,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0);S(E)&&_(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Be){for(let Le=0,Ve=pe.length;Le<Ve;Le++){const Xe=pe[Le],Se=r.get(Xe);i.bindTexture(s.TEXTURE_2D,Se.__webglTexture),xe(s.TEXTURE_2D,Xe),De(ee.__webglFramebuffer,O,Xe,s.COLOR_ATTACHMENT0+Le,s.TEXTURE_2D,0),S(Xe)&&_(s.TEXTURE_2D)}i.unbindTexture()}else{let Le=s.TEXTURE_2D;if((O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(Le=O.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Le,ce.__webglTexture),xe(Le,E),E.mipmaps&&E.mipmaps.length>0)for(let Ve=0;Ve<E.mipmaps.length;Ve++)De(ee.__webglFramebuffer[Ve],O,E,s.COLOR_ATTACHMENT0,Le,Ve);else De(ee.__webglFramebuffer,O,E,s.COLOR_ATTACHMENT0,Le,0);S(E)&&_(Le),i.unbindTexture()}O.depthBuffer&&Nt(O)}function I(O){const E=O.textures;for(let ee=0,ce=E.length;ee<ce;ee++){const pe=E[ee];if(S(pe)){const oe=N(O),Be=r.get(pe).__webglTexture;i.bindTexture(oe,Be),_(oe),i.unbindTexture()}}}const xn=[],Mt=[];function ht(O){if(O.samples>0){if(_t(O)===!1){const E=O.textures,ee=O.width,ce=O.height;let pe=s.COLOR_BUFFER_BIT;const oe=O.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Be=r.get(O),Le=E.length>1;if(Le)for(let Xe=0;Xe<E.length;Xe++)i.bindFramebuffer(s.FRAMEBUFFER,Be.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Xe,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,Be.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Xe,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,Be.__webglMultisampledFramebuffer);const Ve=O.texture.mipmaps;Ve&&Ve.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Be.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Be.__webglFramebuffer);for(let Xe=0;Xe<E.length;Xe++){if(O.resolveDepthBuffer&&(O.depthBuffer&&(pe|=s.DEPTH_BUFFER_BIT),O.stencilBuffer&&O.resolveStencilBuffer&&(pe|=s.STENCIL_BUFFER_BIT)),Le){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Be.__webglColorRenderbuffer[Xe]);const Se=r.get(E[Xe]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Se,0)}s.blitFramebuffer(0,0,ee,ce,0,0,ee,ce,pe,s.NEAREST),m===!0&&(xn.length=0,Mt.length=0,xn.push(s.COLOR_ATTACHMENT0+Xe),O.depthBuffer&&O.resolveDepthBuffer===!1&&(xn.push(oe),Mt.push(oe),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Mt)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,xn))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Le)for(let Xe=0;Xe<E.length;Xe++){i.bindFramebuffer(s.FRAMEBUFFER,Be.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Xe,s.RENDERBUFFER,Be.__webglColorRenderbuffer[Xe]);const Se=r.get(E[Xe]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,Be.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Xe,s.TEXTURE_2D,Se,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,Be.__webglMultisampledFramebuffer)}else if(O.depthBuffer&&O.resolveDepthBuffer===!1&&m){const E=O.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[E])}}}function ke(O){return Math.min(l.maxSamples,O.samples)}function _t(O){const E=r.get(O);return O.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function Ze(O){const E=d.render.frame;g.get(O)!==E&&(g.set(O,E),O.update())}function rt(O,E){const ee=O.colorSpace,ce=O.format,pe=O.type;return O.isCompressedTexture===!0||O.isVideoTexture===!0||ee!==As&&ee!==Va&&(At.getTransfer(ee)===zt?(ce!==mi||pe!==sa)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",ee)),E}function Qt(O){return typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement?(p.width=O.naturalWidth||O.width,p.height=O.naturalHeight||O.height):typeof VideoFrame<"u"&&O instanceof VideoFrame?(p.width=O.displayWidth,p.height=O.displayHeight):(p.width=O.width,p.height=O.height),p}this.allocateTextureUnit=se,this.resetTextureUnits=le,this.setTexture2D=he,this.setTexture2DArray=B,this.setTexture3D=Z,this.setTextureCube=Y,this.rebindTextures=It,this.setupRenderTarget=gt,this.updateRenderTargetMipmap=I,this.updateMultisampleRenderTarget=ht,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=De,this.useMultisampledRTT=_t}function W1(s,e){function i(r,l=Va){let u;const d=At.getTransfer(l);if(r===sa)return s.UNSIGNED_BYTE;if(r===wh)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Dh)return s.UNSIGNED_SHORT_5_5_5_1;if(r===Vv)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===Hv)return s.BYTE;if(r===Gv)return s.SHORT;if(r===Po)return s.UNSIGNED_SHORT;if(r===Ch)return s.INT;if(r===br)return s.UNSIGNED_INT;if(r===ta)return s.FLOAT;if(r===Vo)return s.HALF_FLOAT;if(r===kv)return s.ALPHA;if(r===Xv)return s.RGB;if(r===mi)return s.RGBA;if(r===zo)return s.DEPTH_COMPONENT;if(r===Io)return s.DEPTH_STENCIL;if(r===Wv)return s.RED;if(r===Uh)return s.RED_INTEGER;if(r===qv)return s.RG;if(r===Lh)return s.RG_INTEGER;if(r===Nh)return s.RGBA_INTEGER;if(r===wu||r===Du||r===Uu||r===Lu)if(d===zt)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===wu)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Du)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===Uu)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Lu)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===wu)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Du)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===Uu)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Lu)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Yd||r===jd||r===Zd||r===Kd)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Yd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===jd)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Zd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===Kd)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Qd||r===Jd||r===$d)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(r===Qd||r===Jd)return d===zt?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===$d)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===eh||r===th||r===nh||r===ih||r===ah||r===rh||r===sh||r===oh||r===lh||r===uh||r===ch||r===fh||r===dh||r===hh)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(r===eh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===th)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===nh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===ih)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===ah)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===rh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===sh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===oh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===lh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===uh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===ch)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===fh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===dh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===hh)return d===zt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Nu||r===ph||r===mh)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(r===Nu)return d===zt?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===ph)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===mh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===Yv||r===gh||r===_h||r===vh)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(r===Nu)return u.COMPRESSED_RED_RGTC1_EXT;if(r===gh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===_h)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===vh)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Bo?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:i}}const q1=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!1}),g=new bi(m,p);h.add(g);let v;const x=()=>{p.uniforms.uTime.value+=.01,u.render(h,d),v=requestAnimationFrame(x)};x();const M=()=>{const T=window.innerWidth,R=window.innerHeight;u.setSize(T,R),d.aspect=T/R,d.updateProjectionMatrix()};return window.addEventListener("resize",M),()=>{cancelAnimationFrame(v),window.removeEventListener("resize",M),s.current&&u.domElement.parentNode===s.current&&s.current.removeChild(u.domElement),u.dispose()}},[i]),Re.jsxs(Re.Fragment,{children:[i&&Re.jsx("div",{ref:s,style:{width:"100vw",height:"100vh",overflow:"hidden",margin:0,padding:0,position:"fixed",top:0,left:0,zIndex:0}}),i&&Re.jsx(tR,{}),Re.jsxs(hy,{children:[Re.jsx(Ld,{path:"/",element:Re.jsx(eR,{})}),Re.jsx(Ld,{path:"/MainPage",element:Re.jsx(fR,{})})]})]})}ES.createRoot(document.getElementById("root")).render(Re.jsx(de.StrictMode,{children:Re.jsx(By,{basename:"/portfolio/",children:Re.jsx(dR,{})})}));
